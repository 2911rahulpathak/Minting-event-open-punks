				...
				<section id='welcome' className='welcome'>
					...
					<Row className='header my-3 p-3 mb-0 pb-0'>
						<Col xs={12} md={12} lg={8} xxl={8}>
							<h1>Open Punks</h1>
							<p className='sub-header'>Availble on 10 / 01 / 23</p>
						</Col>
						<Col className='flex social-icons'>
							<a
								href="https://twitter.com/__RahulPathak__"
								target='_blank'
					...
					<Row className='flex m-3'>
						...
						<Col md={5} lg={4} xl={5} xxl={4}>
							...
							<p className='text'>
							You'll learn how to generate NFT images, upload to IPFS, create your NFT contract, and use OpenSea!
							</p>
							...
							{isError ? (
								...
								<div>
									...
									<ul>
										...
										<li>Free minting on Polygon Mumbai</li>
